...
(() => {
  ...
  return (
    <Container width={360} height={120} color={theme.background.container} padding={12}>
      <RichText spacing={2} runSpacing={8}>
        <Text text="这是一段包含" fontSize={14} lineHeight={24} color={theme.text.primary} />
        <Text
          text="加粗"
          fontSize={14}
          lineHeight={24}
        ...
        />
        <Text text="、" fontSize={14} lineHeight={24} color={theme.text.primary} />
        <Text text="不同颜色" fontSize={14} lineHeight={24} color={theme.primary} />
        <Text text="以及自动换行的文字。" fontSize={14} lineHeight={24} color={theme.text.primary} />
      </RichText>
    </Container>
  );
})()
  ...
  return (
    <Container width={360} height={120} color={theme.background.container} padding={12}>
      <RichText spacing={4} runSpacing={8}>
        <Text text="2023、2024、" fontSize={14} lineHeight={24} color={theme.text.primary} />
        <Text
          text="HAHAHA"
          fontSize={14}
          lineHeight={24}
          ...
          color={theme.text.primary}
        />
        <Text text="，继续保持一致的基线。" fontSize={14} lineHeight={24} color={theme.text.primary} />
      </RichText>
    </Container>
  );
})()
  ...
  return (
    <Container width={360} height={120} color={theme.background.container} padding={12}>
      <RichText spacing={4} runSpacing={8} alignBaseline={false}>
        <Text text="普通文本" fontSize={14} lineHeight={24} color={theme.text.primary} />
        <Container color={theme.background.surface} padding={4} borderRadius={6}>
          <Text
            text="行内代码"
            fontSize={12}
            lineHeight={20}
