...
<Container width={260} height={160}>
  <Stack alignment="center" fit="loose">
    <Container width={120} height={80} color="#e6f4ff" />
    <Container width={80} height={40} color="#fff7e6" />
  </Stack>
</Container>
```
...
/** @jsxImportSource @/utils/compiler */
<Stack>
  <Container color="#e6f4ff" width={80} height={80} />
