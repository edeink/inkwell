...
import { fitBounds, computeViewportRect } from '../minimap/utils';

describe('minimap core conversions', () => {
  it('fitBounds computes scale and offsets correctly', () => {
  ...
  it('computeViewportRect maps view to minimap rectangle', () => {
