...
describe('Padding 组件', () => {
  it('应处理数字类型的输入', () => {
    const padding = new Padding({ padding: 10 });
  ...
  it('应处理 EdgeInsets 对象类型的输入', () => {
    ...
    const padding = new Padding({ padding: insets });
  ...
  it('应处理双元素数组输入 [vertical, horizontal]', () => {
    ...
    const padding = new Padding({ padding: [8, 12] });
  ...
  it('应处理三元素数组输入 [top, horizontal, bottom]', () => {
    ...
    const padding = new Padding({ padding: [8, 12, 4] });
  ...
  it('应处理四元素数组输入 [top, right, bottom, left]', () => {
    ...
    const padding = new Padding({ padding: [8, 12, 4, 16] });
  ...
  it('应处理无效的数组长度（空数组）', () => {
    ...
    const padding = new Padding({ padding: [] });
  ...
  it('当 createElement 使用新属性调用时应更新 padding', () => {
    ...
    padding.createElement({ padding: [20, 30] });
