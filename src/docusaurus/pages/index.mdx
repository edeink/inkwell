...
import { industryBenchmarks, performanceDisclaimer } from '@site/src/docusaurus/data/benchmarks';
    ...
    <div className={styles.statsGrid}>
      <div className={styles.statCard}>
        ...
        <p className={styles.statDesc}>
          剥离 WebKit 冗余，<br/>实现轻量化部署
        </p>
        <div className={styles.statSource}>
          <span className={styles.sourceLabel}>参考：</span>
          <a href={industryBenchmarks.find(b => b.id === 'kuaishou-kwaijs')?.source.url} target="_blank" rel="noopener noreferrer">
            快手 KwaiJS
          </a>
        </div>
      </div>
      ...
      <div className={styles.statCard}>
        ...
        <p className={styles.statDesc}>
          去 DOM 树化，<br/>降低复杂页面开销
        </p>
        <div className={styles.statSource}>
          <span className={styles.sourceLabel}>参考：</span>
          <a href={industryBenchmarks.find(b => b.id === 'alibaba-kraken')?.source.url} target="_blank" rel="noopener noreferrer">
            阿里 Kraken
          </a>
        </div>
      </div>
      ...
      <div className={styles.statCard}>
        ...
        <div className={styles.statSource}>
          <span className={styles.sourceLabel}>参考：</span>
          <a href={industryBenchmarks.find(b => b.id === 'tencent-pag')?.source.url} target="_blank" rel="noopener noreferrer">
            腾讯 PAG
          </a>
        </div>
      </div>
  ...
  <section className={styles.ecosystemSection}>
    ...
    <div className={styles.ecosystemGrid}>
      ...
      <div className={styles.ecosystemCard}>
        ...
        <a className={styles.learnMoreBtn} href="/docs/advanced/devtools">了解更多 →</a>
      </div>

      {/* Ink Design UI Library */}
      <div className={styles.ecosystemCard}>
        <div className={styles.screenshot}>
           <div className={styles.fakeToolbar}>
            <div className={`${styles.dot} ${styles.r}`}></div>
          ...
          <div className={styles.fakeContent} style={{ justifyContent: 'center', alignItems: 'center', gap: 16 }}>
