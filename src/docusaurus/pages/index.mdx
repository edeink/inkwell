...
<Container padding={24} borderRadius={16} color="#0d1117" width={500}>
  <Column spacing={16} crossAxisAlignment="center" mainAxisSize="min">
    <Text text="InkWell Studio" fontSize={24} color="#1677ff" fontWeight={700} />
    <Wrap spacing={16} runSpacing={24}>
      {[
        ...
        <Container width={140} height={90} color={color} borderRadius={12}>
          <Center>
            <Text text={text} fontSize={16} color="#f0f0f0" fontWeight={600} />
          </Center>
        </Container>
      ))}
    </Wrap>
...
<div className={styles.scrollContainer}>
  ...
  <section className={styles.jsxSection}>
    ...
    <BrowserOnly>
      {() => (
        <InkPlayground showcase code={showcaseCode} />
      )}
    </BrowserOnly>
  </section>
  ...
  <section className={styles.perfSection}>
    ...
    <div className={styles.chartContainer}>
      ...
      <div style={{ textAlign: 'center' }}>
        <a className={styles.perfBtn} href="/docs/benchmark">在线测试</a>
      </div>
    </div>
  </section>
  ...
  <section className={styles.devtoolsSection}>
    ...
    <div className={styles.toolShowcase}>
      ...
      <p className={styles.toolDesc}>像调试 DOM 一样调试 Canvas。Inkwell DevTools 提供完整的节点树视图和属性检查器。</p>
