...
export function BugOutlined(props: IconBaseProps) {
  return (
    <SvgIcon {...props}>
      <path d="M512 192c-154.5 0-288 100.3-288 232 0 16 1.9 31.7 5.5 47L170 528.2c-5.9 7.4-4.8 18.1 2.6 24.1 7.4 5.9 18.1 4.8 24.1-2.6l64.6-80.9c71.6 26.5 156.4 42.1 247.7 42.8L512 832h-64c-8.8 0-16 7.2-16 16s7.2 16 16 16h128c8.8 0 16-7.2 16-16s-7.2-16-16-16h-64V511.6c91.3-.7 176.1-16.3 247.7-42.8l64.6 80.9c2.9 3.6 7.1 5.4 11.3 5.4 5.4 0 10.7-2.6 13.8-7.5 5.2-8.2 2.8-19.1-5.4-24.3l-55-68.8c3.6-15.3 5.5-31 5.5-47 0-131.7-133.5-232-288-232z" />
      <path d="M352 384c0-17.7-14.3-32-32-32s-32 14.3-32 32 14.3 32 32 32 32-14.3 32-32zm352 0c0-17.7-14.3-32-32-32s-32 14.3-32 32 14.3 32 32 32 32-14.3 32-32z" />
    </SvgIcon>
  );
}
